...
const player1ChooseLeader = () => {
    ...
    avatar1Button.addEventListener('click', (e) =>{
        selectedPiece = {name: 'Unloden', src: "images/Leader_Fighter.png", scalarH: 0.8, leader: true, class_type: 4, hp: 145, hp_max: 145, atk: 13, atk_range: 1, move_range: 5, cell: "7_1"}
        renderSelectedMinion()
    })

    avatar2Button.addEventListener('click', (e) =>{
        selectedPiece ={name: 'Valwren', src: "images/Leader_Archer.png", scalarH: 1, leader: true, class_type: 5, hp: 125, hp_max: 125, atk: 12, atk_range: 3, move_range: 5, cell: "7_1"}
        renderSelectedMinion()
    })

    avatar3Button.addEventListener('click', (e) =>{
        selectedPiece ={name: 'Maknasty', src: "images/Leader_Mage.png", scalarH: 0.8, leader: true, class_type: 6, hp: 90, hp_max: 90, atk: 20, atk_range: 2, move_range: 5, cell: "7_1"}
        renderSelectedMinion()
    })
...
const player2ChooseLeader = () => {
    ...
    avatar1Button.addEventListener('click', (e) =>{
        selectedPiece = {name: 'Unloden', src: "images/Leader_Fighter.png", scalarH: 0.8, leader: true, class_type: 4, hp: 145, hp_max: 145, atk: 13, atk_range: 1, move_range: 5, cell: "7_16"}
        renderSelectedMinion()
    })

    avatar2Button.addEventListener('click', (e) =>{
        selectedPiece ={name: 'Valwren', src: "images/Leader_Archer.png", scalarH: 1, leader: true, class_type: 5, hp: 125, hp_max: 125, atk: 12, atk_range: 3, move_range: 5, cell: "7_16"}
        renderSelectedMinion()
    })

    avatar3Button.addEventListener('click', (e) =>{
        selectedPiece ={name: 'Maknasty', src: "images/Leader_Mage.png", scalarH: 0.8, leader: true, class_type: 6, hp: 90, hp_max: 90, atk: 20, atk_range: 2, move_range: 5, cell: "7_16"}
        renderSelectedMinion()
    })
